...
;; Repeat the integrated suites after the archived independent :AROUND
;; instrumentation is loaded. The shared passive :BEFORE observers must coexist.
...
(format t "~&CAS-INTEGRATED-REPEAT-AND-INDEPENDENT-156-PASS~%")
