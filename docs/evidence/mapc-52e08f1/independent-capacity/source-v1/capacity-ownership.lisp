;;;; SOURCE ONLY against /tmp/clamsara-mapc-draft-wd3ba0th.
;;;; Not loaded, compiled, or executed. No passing results are claimed.
...
(defstruct cap-owner runtime provider spec phase condition
  ...
  reservation (snapshot-count 0) (moving-cycles 0) (inner-rejections 0))
...
(defun cap-note (o phase) (setf (cap-owner-phase o) phase))
