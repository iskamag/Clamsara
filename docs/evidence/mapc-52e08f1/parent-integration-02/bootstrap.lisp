...
(asdf:initialize-source-registry
 '(:source-registry (:directory #p"/tmp/clamsara-mapc-integrated2-0gtrq1cb/") :ignore-inherited-configuration))
(asdf:initialize-output-translations
 '(:output-translations (t ("/tmp/clamsara-mapc-integration2-native-ro_f9w5j/fasl/" :implementation)) :ignore-inherited-configuration))
(assert (equal (truename #p"/tmp/clamsara-mapc-integrated2-0gtrq1cb/")
