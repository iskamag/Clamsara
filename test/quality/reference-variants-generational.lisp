...
(defun run-row-generational-acceptance ()
  ...
  (event :generational-finished :passed *passed* :failed *failed*)
  (when (plusp *failed*)
    (error "Variant promotion acceptance failed: ~D failures (~D passes)"
           *failed* *passed*))
  t)
