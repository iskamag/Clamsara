...
(asdf:initialize-output-translations '(:output-translations (t ("/tmp/clamsara-shared-copy-core2-vkr9k1vj/fasl/" :implementation)) :ignore-inherited-configuration))
...
(let ((report (uiop:symbol-call :clamsara.structure :check-project-structure :include-optional-loaded t)))
  ...
  (with-open-file (stream #p"/tmp/clamsara-shared-copy-core2-vkr9k1vj/wrong-mode-diagnostic.sexp" :direction :output :if-exists :error)
